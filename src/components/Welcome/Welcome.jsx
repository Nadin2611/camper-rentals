    ...
    <WelcomeContainer>
      <TextContainer>
        ...
        <TextWrap>
          ...
          <Paragraph>
            Our mission is to provide you with unforgettable experiences,
            whether you're craving the tranquility of the Carpathian Mountains,
            the vibrant atmosphere of Kyiv, or the serenity of the Black Sea
            coast.
          </Paragraph>
          <Paragraph>
            At CamperDreamUA, we understand the importance of flexibility and
            freedom in your travel plans. That's why we offer camper rentals
            that give you the independence to explore Ukraine at your own pace.
          </Paragraph>
          <Paragraph>
